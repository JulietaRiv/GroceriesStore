		...
		<div class="container">
			...
			<div class="col-md-8 products-right">
				...
				<div class="products-right-grids">
					<div class="sorting">
						<select id="order" name="order" onchange="javascript:handleSelect(this)" class="frm-field required sect">
					...
					<div class="sorting-left">
						<select id="items" onchange="javascript:handleSelelect(this)" class="frm-field required sect">
