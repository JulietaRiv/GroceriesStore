				...
				<div class="hover14 column">
					<div class="agile_top_brand_left_grid">
						<div class="agile_top_brand_left_grid_pos">
							...
							@if ($product->organic == 1)<img style="width:30px;" src="/site/images/organicos.png" alt=" " class="img-responsive">@endif
							...
							@if ($product->vegan == 1)<img style="width:30px;" src="/site/images/veganos.png" alt=" " class="img-responsive">@endif
						</div>
